def test_power_on_state(controller, vm_service, vrouter_port_service, vmware_vm_1, vm_power_on_state_update):
...
def test_power_off_state(controller, vm_service, vrouter_port_service, vmware_vm_1, vm_power_off_state_update):
