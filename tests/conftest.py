...
@pytest.fixture()
def vnc_vn_1():
    return create_vnc_vn(name='DPG1', uuid='vnc-vn-uuid-1')


@pytest.fixture()
def vnc_vn_2():
    return create_vnc_vn(name='DPG2', uuid='vnc-vn-uuid-2')
...
def vcenter_api_client():
    ...
    vcenter_client.get_reserved_vlans_for_dpg.return_value = []
